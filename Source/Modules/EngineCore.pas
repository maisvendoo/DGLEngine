...
//                                                                            //
// EngineCore.pas V 1.0, 26.01.2006                                           //
//                                                                            //
...
begin
      ...
      if not InitFullScreen then Sleep(1);
...
begin
  ...
  glResizeWnd(Width, Height);
      ...
      begin
      glGetIntegerv(GL_MAX_TEXTURE_UNITS_ARB,@i);
      AddToLogFile(EngineLog,'Maximum multytexturing layers:'+inttostr(i));
      end;
