...
B : TBitmap;
begin
if Birthday then ResourceStream :=TResourceStream.Create(hInstance, 'BIRTH', 'LOGO') else
 if random(2)=1 then
...
begin
  ...
  glTexImage2D(Texture, 0, GL_RGB, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, pdata);
